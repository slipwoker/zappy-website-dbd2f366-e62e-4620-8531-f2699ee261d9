document.addEventListener('DOMContentLoaded', function () {
  ...
  const animatedElements = document.querySelectorAll(
    '.animate-on-scroll, [data-animate], .feature-card, .service-card, .pricing-card, .testimonial-card, .team-card, .hero-content, .section-header, .cta-block'
  );
  ...
  if (animatedElements.length > 0) {
    ...
    if (!document.getElementById('fade-in-up-styles')) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'dbd2f366-e62e-4620-8531-f2699ee261d9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'dbd2f366-e62e-4620-8531-f2699ee261d9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'dbd2f366-e62e-4620-8531-f2699ee261d9';
